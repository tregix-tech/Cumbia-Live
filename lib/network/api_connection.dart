...
import '../model/dhlPackageData.dart';
...
Future<String> getDHLQoute(String countryFrom, String countryCodeFrom, String toCountry, String toCountyCode) async {
  //final aresponse = await http.get(recentAlbumsURL);
  String xml = DHLPackageData.createRequest(countryFrom,countryCodeFrom,toCountry,toCountyCode);
  print(xml);
  var client = IOClient();
