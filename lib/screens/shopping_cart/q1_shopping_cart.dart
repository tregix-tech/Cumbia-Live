                    ...
                    Row(
                      ...
                      children: [
                        Text(
                          'Saldo disponible',
                          style: TextStyle(
                              color: user.emeralds!= null && user.emeralds < tEmeralds
                                  ? Palette.red
                                  : Palette.grey),
                        ),
                        Row(
                          children: [
                            Text(
                        user.emeralds != null ? "${user.emeralds.toString()} COP " :" 0 COP",
                              style: TextStyle(
                                  color: user.emeralds!= null &&user.emeralds < tEmeralds
                                      ? Palette.red
                                      : Palette.grey),
                            ...
                            onPressed: !canPush()
                                ...
                                : () async {
                                    ...
                                    await References.users
                                        ...
                                        .get()
                                        .then((value) {
                                      print("address: " +References.users
                                          .doc(user.id).toString());

                                      print("address: " +value.data()['addresses'].length.toString());
