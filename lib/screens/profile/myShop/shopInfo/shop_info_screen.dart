...
class _ShopInfoScreenState extends State<ShopInfoScreen> {
  ...
  final TextEditingController countryController =
      TextEditingController(text:  defaultCountry);
  ...
  TextEditingController(text:  merchant.storeLocation != null?  merchant.storeLocation.zipCode:"");
                        ...
                        CumbiaTextField(
                          ...
                          onFieldSubmitted: (value) async {
                            if (value.isNotEmpty) {
                              ...
                              merchant.storeLocation.zipCode = value;
                            } else {
                              return null;
                              //return null;
                            }
