...
class _InfoUserScreenState extends State<InfoUserScreen> {
  ...
  Widget _createAddressItem(
      String country, String city, String address, String zipCode, bool isPrincipal, int id) {
    ...
    var zipCodeController = TextEditingController(text: zipCode??"");
                ...
                children: [
                  Padding(
                    ...
                    child: Text(
                      "Pias",
                      style: Styles.txtTitleLbl.copyWith(
                        color: isPrincipal ? Palette.cumbiaLight : null,
                        fontSize: 12,
                      ),
                    ),
                  ),
                    ...
                    child: Center(
                      child: Padding(
                        ...
                        child: DropdownButton<String>(
                          ...
                          items: Constants.listOfCountries.map((var value) {
    ...
    setState(() {
      ...
      for (var i = 0; i < dataAddress.length; i++) {
        address.add(_createAddressItem(
            ...
            dataAddress[i]['zipCode'].toString(),
